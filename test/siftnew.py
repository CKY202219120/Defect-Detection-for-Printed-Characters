...
def run(template_path, test_path, out_dir, match_thr=0.45):
    ...
    for i, (x, y, w, h) in enumerate(boxes, 1):
        ...
        # 缺陷检测
        defects = detect_defects(template_gray, aligned, char_mask, min_area=15)
        ...
        diff_show = put_title(to_bgr(cv2.absdiff(template_gray, aligned)), "Diff")
        panel = hstack_resize([tpl_show, ali_show, diff_show], h=200)
        cv2.imwrite(os.path.join(out_dir, f"bottle_{i:02d}_debug.jpg"), panel)
...
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew.py" --template "C:/Users/ASUS/Desktop/test/3/template.jpg" --test "C:/Users/ASUS/Desktop/test/3/test.jpg" --out "C:/Users/ASUS/Desktop/test/3/output" --match_thr 0.36   
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew.py" --template "C:/Users/ASUS/Desktop/test/4/template.jpg" --test "C:/Users/ASUS/Desktop/test/4/test.jpg" --out "C:/Users/ASUS/Desktop/test/4/output" --match_thr 0.2   
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew.py" --template "C:/Users/ASUS/Desktop/test/2/template.jpg" --test "C:/Users/ASUS/Desktop/test/2/test.jpg" --out "C:/Users/ASUS/Desktop/test/2/output" --match_thr 0.45   
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew.py" --template "C:/Users/ASUS/Desktop/test/1/template.jpg" --test "C:/Users/ASUS/Desktop/test/1/test.jpg" --out "C:/Users/ASUS/Desktop/test/1/output" --match_thr 0.3   
