...
def detect_defects_optimized(template_gray, aligned, char_mask, tol_pixels=2, min_area=5):
    """
    基于骨架提取与邻域容差的字符缺陷检测，并返回中间过程进行调试
    """
    # 1. 局部自适应二值化
    # 注意：THRESH_BINARY_INV 假设原图文字是暗色，背景是亮色，处理后文字将变为白色。
    # 如果你的药瓶文字本来就是亮色，背景是暗色，请改为 cv2.THRESH_BINARY ！！！
    th_t = cv2.adaptiveThreshold(template_gray, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, 
...
def run(template_path, test_path, out_dir, match_thr=0.45):
    ...
    for i, (x, y, w, h) in enumerate(boxes, 1):
        ...
        diff_show = put_title(to_bgr(cv2.absdiff(template_gray, aligned)), "Abs Diff")
        panel1 = hstack_resize([tpl_show, ali_show, diff_show], h=200)
...
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew skeleton.py" --template "C:/Users/ASUS/Desktop/test/3/template.jpg" --test "C:/Users/ASUS/Desktop/test/3/test.jpg" --out "C:/Users/ASUS/Desktop/test/3/output" --match_thr 0.36   
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew skeleton.py" --template "C:/Users/ASUS/Desktop/test/4/template.jpg" --test "C:/Users/ASUS/Desktop/test/4/test.jpg" --out "C:/Users/ASUS/Desktop/test/4/output" --match_thr 0.2   
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew skeleton.py" --template "C:/Users/ASUS/Desktop/test/2/template.jpg" --test "C:/Users/ASUS/Desktop/test/2/test.jpg" --out "C:/Users/ASUS/Desktop/test/2/output" --match_thr 0.45   
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew skeleton.py" --template "C:/Users/ASUS/Desktop/test/1/template.jpg" --test "C:/Users/ASUS/Desktop/test/1/test.jpg" --out "C:/Users/ASUS/Desktop/test/1/output" --match_thr 0.3
