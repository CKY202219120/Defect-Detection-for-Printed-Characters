...
def detect_defects_optimized(template_gray, aligned, char_mask, tol_pixels=2, min_area=5):
    ...
    def clean_binary(binary_image):
        ...
        for cnt in contours:
            ...
            if 20 < area < 5000:
                # 在 mask 上把整个外轮廓填满（此时 0 会变成实心的）
                cv2.drawContours(mask, [cnt], -1, 255, -1)
                
        # (3) 核心修复：用这个充满原位置体型的安全掩膜(mask)，去“扣取”最原始的二值图。
        # 这样原始图像里 0 中间的黑洞就被完美保留了，而不在掩膜里的杂质会被剔除。
        cleaned = cv2.bitwise_and(binary_image, mask)
...
def run(template_path, test_path, out_dir, match_thr=0.45):
    ...
    for i, (x, y, w, h) in enumerate(boxes, 1):
        ...
        print(f"瓶子 #{i} SIFT 配准耗时: {register_time * 1000:.2f} ms")
        ...
        # 增加展示 50:50 融合效果
        blended_show = cv2.addWeighted(template_gray, 0.2, aligned, 0.8, 0)
    ...
    time_summary = f"SIFT Avg Time: {avg_time:.2f} ms/bottle" # <--- 新增
    
    cv2.rectangle(overview, (0,0), (overview.shape[1], 55), (245,245,245), -1)
    cv2.putText(overview, summary, (10,23), cv2.FONT_HERSHEY_SIMPLEX,
                0.65, (30,30,30), 2, cv2.LINE_AA)
...
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew skeleton filter addweight.py" --template "C:/Users/ASUS/Desktop/test/3/template.jpg" --test "C:/Users/ASUS/Desktop/test/3/test3.jpg" --out "C:/Users/ASUS/Desktop/test/3/output" --match_thr 0.36   
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew skeleton filter addweight.py" --template "C:/Users/ASUS/Desktop/test/4/template.jpg" --test "C:/Users/ASUS/Desktop/test/4/test.jpg" --out "C:/Users/ASUS/Desktop/test/4/output" --match_thr 0.35   
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew skeleton filter addweight.py" --template "C:/Users/ASUS/Desktop/test/2/template.jpg" --test "C:/Users/ASUS/Desktop/test/2/test.jpg" --out "C:/Users/ASUS/Desktop/test/2/output" --match_thr 0.45   
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew skeleton filter addweight.py" --template "C:/Users/ASUS/Desktop/test/1/template.jpg" --test "C:/Users/ASUS/Desktop/test/1/test.jpg" --out "C:/Users/ASUS/Desktop/test/1/output" --match_thr 0.3
# D:/minicoda/python.exe "c:/Users/ASUS/Desktop/test/siftnew skeleton filter addweight.py" --template "C:/Users/ASUS/Desktop/test/5/template.jpg" --test "C:/Users/ASUS/Desktop/test/5/test.jpg" --out "C:/Users/ASUS/Desktop/test/5/output" --match_thr 0.35
